...
//        }
//        _ = self.stringFromEvaluatingJavaScript(jsToExecute: "player.pauseVideo();", completion: <#(String) -> Void#>)
//    }
//
//    public func petitVolume(){
//        _ = self.stringFromEvaluatingJavaScript(jsToExecute: "player.setVolume(1);")
//    }
//
//
//    /**
...
//        guard let result = Int(self.stringFromEvaluatingJavaScript(jsToExecute: "player.getPlaylistIndex();", completion: <#((String) -> Void)?#>)) else {
//            return 0
//        }
//        return result
//    }
...
//     */
//    private func stringFromEvaluatingJavaScript(jsToExecute: String, completion: ((String) -> Void)?) {
//         self.webView.evaluateJavaScript(jsToExecute, completionHandler: { data, error in
...
//        self.webView.configuration.mediaPlaybackRequiresUserAction = false
//
